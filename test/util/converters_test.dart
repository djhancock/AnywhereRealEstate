...
void main() {
  group("TheWireCharacterConverter", () {
    final jsonObject = <String, dynamic>{
      ...
      "Icon": {"Height": "100", "URL": "/i/521af1f0.jpg", "Width": ""},
      "Result":
      ...
      "Text":
          "Bubbles (The Wire) - Reginald \"Bubbles\" Cousins is a fictional character on the HBO drama The Wire, played by actor Andre Royo. Bubbles is a recovering heroin addict. His real name is not revealed until a fourth-season episode when he is called \"Mr. Cousins\" and in the fifth-season premiere when he is called \"Reginald\"."
    };
    ...
    test('The character properties are properly parsed', () {
      ...
      expect(character.firstUrl,
          Uri.parse("https://duckduckgo.com/Bubbles_(The_Wire)"));
      expect(
          character.icon,
          CharacterIconMatcher(CharacterIcon(
              uri: Uri.parse("http://test.com/i/521af1f0.jpg"),
              height: 100,
              width: null)));
  ...
  group("TheSimpsonsCharacterConverter", () {
    ...
    test('The character properties are properly parsed', () {
      ...
      expect(character.firstUrl,
          Uri.parse("https://duckduckgo.com/Barney_Gumble"));
      expect(
          character.icon,
          CharacterIconMatcher(CharacterIcon(
              uri: Uri.parse("http://test.com/i/39ce98c0.png"),
              height: null,
              width: null)));
    ...
    test('isFamilyMember is properly Parsed', () async {
      ...
      copy['Text'] = (copy['Text'] as String)
          .replaceFirst("Barney Gumble", "Barney Simpson");
    ...
    test('isSideCharacter is properly Parsed', () async {
      ...
      copy['Text'] =
          "${(copy['Text'] as String)} The Simpsons includes a large array of supporting/minor characters";
      character1 = converter.convert(copy);
